...
from MOON_GOLF_classism import *
from MOON_GOLF_contants import *
...
def ball_xy(ball):
    return origin[0] + ball.pos.x*scale, origin[1] - ball.pos.y*scale
...
populations = [Population(100, 20, Ball(45, speed=20, wind=Vec(0, 0, 0))),]
