...
from A_APPROACH_classism import *
from A_APPROACH_contants import *

# Constants - sets the size of the window
window_bounds = WIDTH, HEIGHT, scale = 600, 600, 2
...
populations = [Population(100, 20, Ball(45, Vec(0, 8), speed=45, wind=Vec(0, 0, 0), spin=Vec(0, 0, 500))),
               Population(100, 20, Ball(45, Vec(0, 8), speed=45, wind=Vec(-5, 0, 0), spin=Vec(0, 0, 500))),
               Population(100, 20, Ball(45, Vec(0, 8), speed=45, wind=Vec(5, 0, 0), spin= Vec(0, 0, 500)))]

# populations = [Population(100, 20, Ball(45, Vec(0, 8), speed=45, wind=Vec(0, 0, 0), spin=Vec(0, 0, 500))),]

target = Ball(0, Vec(160, 0))
